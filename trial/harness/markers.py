...
Every detected id is a fiducial. The referee-tag split this file used to
apply (one id held out to grade against) was removed 2026-07-22 with the
marker-truth benchmark; relocalization is scored against the premap now.
